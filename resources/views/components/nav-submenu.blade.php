...
<div x-data="{ isExpanded: {{ $active ? 'true' : 'false' }} }" class="flex flex-col">
    <button type="button"
            ...
            class="flex items-center justify-between rounded-xl gap-2 px-2 py-1.5 text-sm font-medium underline-offset-2 focus:outline-hidden focus-visible:underline"
